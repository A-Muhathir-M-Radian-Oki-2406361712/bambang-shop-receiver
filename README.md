...
1. Ya, saya sudah mengeksplor sedikit, terutama saat mencoba debugging penambahan mod yang dapat dilakukan di main.rs atau mod.rs pada root, di lib.rs saya juga menemukan beberapa libraries buatan yang dipakai di beberapa file seperti compose_error_response dan beberapa struct pembangun aplikasi.
2. Penerapan pattern akan membuat penambahan subscriber menajdi mudah, hanya dengan POST ke notification/subscribe pakai URL dan receiver baru sehingga tidak perlu buat source code di aplikasi utamanya lagi. Jika instance main app lebih dari satu, akan lebih susah untuk mengimplementasikannya semenjak disimpan di SubscriberRepository sebelumnya.
3. Belum